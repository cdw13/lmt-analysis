...
# Event-builder module for ObjectSniffingNorAcquisitionWithConfig.
#
...
# Example: Example: import BuildEventObjectSniffingNorAcquisitionWithConfig or run as script if __main__ present.
'''
