...
# Event-builder module for ObjectSniffingNorTestWithConfig.
#
...
# Example: Example: import BuildEventObjectSniffingNorTestWithConfig or run as script if __main__ present.
'''
